...
public class Registration_Booking_a extends GenericFunctions
...
//Resgister tab >>flights.>booking>>logout
 ...
 //Home page title validation
        ...
        System.out.println( "Assert passed: Home page launched" );

        Registration_Tab Re= new Registration_Tab(driver);
        Re.Regis();
 //Registration page title validation
        assertss(driver.getTitle() , "Register: Mercury Tours" );
        System.out.println( "Assert passed: Registration  page launched " );
        Thread.sleep( 3000 );
        Re.First( "Bindu" );
        Re.Last("Basavaraju"  );
        Re.Ph( "9141000000" );
        ...
        Re.Sub();
        Thread.sleep( 5000 );
//Successfull registration validation
